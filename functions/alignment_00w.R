...
alignment = function(input = primer_tag_ngs, ncores = detectCores()){
  ...
  clusterEvalQ(cl, c(library(dplyr), library(Biostrings), library(stringr)))
  clusterExport(cl, c("primer_tag_ngs2", "fictional03", "fictional06", "fictional17"), envir = environment())
  
  fixSeq = parLapply(cl = cl, primer_tag_ngs2, function(y){
